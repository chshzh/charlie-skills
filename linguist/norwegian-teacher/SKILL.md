...
**Usage Notes:**
"Bok" is a common noun that can be treated as either feminine (ei bok → boka) or masculine/common gender (en bok → boken) in Bokmål. The feminine form is more traditional, but the common gender form is widely used, especially in urban areas.

**Three Example Sentences:**

1. Jeg leser en god bok.
   → I'm reading a good book.

2. Boken ligger på bordet.
   → The book is lying on the table.

3. Har du noen norske bøker hjemme?
   → Do you have any Norwegian books at home?
